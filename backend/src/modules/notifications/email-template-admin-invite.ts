...
<body>
  <div class="container">
    ...
    <div class="content">
      <p>Hello,</p>
      <p>You have been invited by <strong>${inviterName}</strong> to join <strong>Digital Queue System Sokoto</strong> as an Administrator.</p>
    ...
    <div class="footer">
      <p>&copy; ${new Date().getFullYear()} Digital Queue System Sokoto. All rights reserved.</p>
    </div>
  </div>
</body>
</html>
